...
qpo.Unit = function(color, gx, gy, num, player, belongs){ //DEFINE UNIT TYPE/CLASS
  ...
  this.snap = function(){this.all.attr({'transform':this.trans()});} //.bind(this) if glitchy
  ...
  this.move = function(dir){
    ...
    this.all.animate({'transform':this.trans()}, 3000*qpo.timeScale, easingType); //move that son of a gun
