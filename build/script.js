...
(function(global) {
  ...
  var Brain = function(num_states, num_actions, opt) {
    ...
    if(typeof opt.random_action_distribution !== 'undefined') {
      ...
      if(Math.abs(s-1.0)>0.0001) { void 0; }
    } else {
    ...
    if(typeof opt.layer_defs !== 'undefined') {
      ...
      if(layer_defs.length < 2) { void 0; }
      if(layer_defs[0].type !== 'input') { void 0; }
      if(layer_defs[layer_defs.length-1].type !== 'regression') { void 0; }
